...
class NeuroEvaBotLocal:
                ...
                async with self.compute_lock:
                    ...
                    if msg_type == "размышление":
                        ...
                        prompts = {
                            ...
                            "философия": ("Размышляй о смысле жизни, вселённой или своём месте в мире. 2-3 предложения.", 120),
    ...
    async def initialize(self):
        request = HTTPXRequest(connect_timeout=120, read_timeout=120, write_timeout=120, pool_timeout=120)
        ...
        self.application.add_handler(CommandHandler("badabadad_secret", commands.badabadad_secret))
